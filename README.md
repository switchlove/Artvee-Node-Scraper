...
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/switchlove/Artvee-Node-Scraper/ci.yml?branch=main&logo=github&logoColor=%23181717)](https://github.com/switchlove/Artvee-Node-Scraper/actions/workflows/ci.yml)
